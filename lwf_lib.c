...
const char *LWF_KMGMT_NAMES[] = {
	"NONE",
	"802.1X",
	"PSK",
};

const char *LWF_AUTH_NAMES[] = {
	"OPEN",
	"SHARED",
};

const char *LWF_OPMODE_NAMES[] = {
	"Unknown",
	"Master",
	"Ad-Hoc",
	"Client",
...
const struct lwf_iso3166_label LWF_ISO3166_NAMES[] = {
	{ 0x3030 /* 00 */, "World" },
	{ 0x4144 /* AD */, "Andorra" },
...
static const struct lwf_ops *backends[] = {
#ifdef USE_NL80211
	&nl80211_ops,
#endif
};
...
{
	const struct lwf_ops *ops = lwf_backend(ifname);
	if (!ops)
		return NULL;
